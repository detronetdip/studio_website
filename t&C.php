...
<p>
  Unless otherwise stated, Nandi Studio and/or its licensors own the
  intellectual property rights for all material on Nandi Studio. All
  intellectual property rights are reserved. You may access this from Nandi
  Studio for your own personal use subjected to restrictions set in these terms
  and conditions.
</p>

<p>You must not:</p>
<ul>
  <li>Republish material from Nandi Studio</li>
  <li>Sell, rent or sub-license material from Nandi Studio</li>
  <li>Reproduce, duplicate or copy material from Nandi Studio</li>
  <li>Redistribute content from Nandi Studio</li>
</ul>

<p>
  This Agreement shall begin on the date 15/02/2021 . Our Terms and Conditions were
...
<p>
  ...
  opinions and information in certain areas of the website. Nandi Studio does
...
<p>
  Nandi Studio reserves the right to monitor all Comments and to remove any
...
<p>
  You hereby grant Nandi Studio a non-exclusive license to use, reproduce, edit
...
<p>
  ...
  absence of Nandi Studio; and (d) the link is in the context of general
...
<p>
  ...
  to Nandi Studio. Please include your name, your organization name, contact
...
<p>
  No use of Nandi Studio's logo or other artwork will be allowed for linking
...
<p>Please read <a href="privacypolicy.php"> Privacy Policy </a></p>

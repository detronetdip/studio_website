...
?>
<div class="crdtl">
<h1>Privacy Policy for Nandi Studio</h1>

<p>
  At Nandi Studio, accessible from https://pnstudio.in/, one of our main
  priorities is the privacy of our visitors. This Privacy Policy document
  contains types of information that is collected and recorded by Nandi Studio
  and how we use it.
</p>
...
<p>
  ...
  and/or collect in Nandi Studio. This policy is not applicable to any
...
<p>
  Nandi Studio follows a standard procedure of using log files. These files log
...
<p>
  ...
  advertising partners of Nandi Studio.
</p>

<p>
  Third-party ad servers or ad networks uses technologies like cookies,
  JavaScript, or Web Beacons that are used in their respective advertisements
  and links that appear on Nandi Studio, which are sent directly to users'
...
<p>
  Note that Nandi Studio has no access to or control over these cookies that are
...
<p>
  Nandi Studio's Privacy Policy does not apply to other advertisers or websites.
...
<p>
  Nandi Studio does not knowingly collect any Personal Identifiable Information
